...
import SavedContacts from "../airtime/SavedContacts";
import InternetHistory from "../InternetHistory";
    ...
    return (
        <main className="pb-10 grid md:grid-cols-[3fr,2fr] gap-14 xl:gap-28">
            <section className="w-full overflow-hidden">
                <p className="font-semibold mb-6">Purchase Data</p>

                <SavedContacts />

                <form className="flex flex-col gap-6 mt-6">
                    <Select id="network" label="Network" placeholder="" value="Glo" options={["Glo", "9mobile", "MTN", "Airtel"]} />
                    <Select id="data-package" placeholder="5 MB" label="Data Package" value="5 MB" options={["5 MB", "10 MB", "20 MB", "1 GB"]} />
                    ...
                    <Button type="submit" label="Purchase Data" block />
                </form>
            </section>
